...
long_passes_range_second_ball = range(0, 1000)
long_passes_list_second_ball = list(long_passes_range_second_ball)
long_passes_range_third_ball = range(0, 1000)
long_passes_list_third_ball = list(long_passes_range_third_ball)
long_passes_input = '''second_ball/third_ball
'''
...
def body():
    ...
    while True:
        ...
        # -----> * Long Passes * <-----
            ...
            if good_bad_input_long_passes == "second_ball":
                first_number_long_passes_second_ball = long_passes_list_second_ball[0]
                long_passes_list_second_ball.remove(first_number_long_passes_second_ball)
                number_long_passes_second_ball = long_passes_list_second_ball[0]
                string_number_long_passes_second_ball = str(number_long_passes_second_ball)
                int_number_long_passes_second_ball = True
                print("Long Pass(es) second_ball: ", string_number_long_passes_second_ball)

            elif good_bad_input_long_passes == "third_ball":
                first_number_long_passes_third_ball = long_passes_list_third_ball[0]
                long_passes_list_third_ball.remove(first_number_long_passes_third_ball)
                number_long_passes_third_ball = long_passes_list_third_ball[0]
                string_number_long_passes_third_ball = str(number_long_passes_third_ball)
                int_number_long_passes_third_ball = True
                print("Long Pass(es) third_ball: ", string_number_long_passes_third_ball)
        ...
        # -----> * Quit Function * <-----
            ...
            if int_number_long_passes_second_ball:
                print("Long Passes Second Ball: ", string_number_long_passes_second_ball)
            elif not int_number_long_passes_second_ball:
                print("Long Passes Second Ball: 0")

            if int_number_long_passes_third_ball:
                print("Long Passes Third Ball: ", string_number_long_passes_third_ball)
