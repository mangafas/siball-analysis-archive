...
def body():
    ...
    global string_number_long_passes_second_ball_attack
    ...
    while True:
        ...
        # -----> * Long Passes * <-----
            ...
            sec_third_input_long_pass_defense = input(long_passes_input_defense)
            ...
            if attack_defense_input_long_pass == "attack":
                ...
                if sec_third_input_long_pass_defense == "second ball":
                ...
                elif sec_third_input_long_pass_defense == "third ball":
