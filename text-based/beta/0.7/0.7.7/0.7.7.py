    ...
    while True:
        ...
        # of each team. Provided that you named the file correctly according
            ...
            if team_input == home:
                ...
                print(blue % possession_13, red % possession_23, red % possession_33)
        ...
        # if the user wants to quit he types q to begin the process
            ...
            if int_number_possession_23_h:
                print("\nPossession(s) on midfield from " + home + ": ", possession_23_2)
            ...
            if int_number_possession_33_h:
                print("\nPossession(s) on attack from " + home + ": ", possession_33_2_h)
            ...
            if int_number_possession_23_a:
                print("\nPossession(s) on midfield from " + away + ": ", possession_23_2)
            ...
            if int_number_possession_33_a:
                print("\nPossession(s) on attack from " + away + ": ", possession_33_2_a)
