...
def body():
    ...
    global pk_goal_2, pk_miss_2
    global fk_string_pd_2, string_number_fk, string_number_ck_pd
    global cross_string_gd_2, cross_string_pd_2
    global header_oft_2, header_ont_2
    global string_number_v1_l, string_number_v1, string_number_v1_w
    global string_number_lpi_tb, string_number_lpi
    global ti_string_gd_2, string_number_ti, pl_23_2
    global lpi_attack_tb_2
    global lpi_attack_2, pl_23_13_2
    global lpi_attack_sb_2, ti_string_pd_2
    global pl_13_23_2, pl_13_2, midfield_input
    global pl_33_2, pl_23_33_2, pl_33_13_2
    global pk_saved_2, string_number_pk, fk_string_gd_2
    global string_number_offside, string_number_pw_23_33_away
    global ck_string_gd_2, string_number_ck, end_away, start_home, team
    global pw_33_home_2, shot_string_oft_2
    global string_number_crosses, string_number_shots, elapsed_away, ball_away
    global string_number_pl, string_number_transition
    global string_number_pw_13_23_away, shot_string_ont_2
    global pw_23_33_home_2, elapsed_home
    global string_number_pw_home, string_number_pw_33_away
    global string_number_lpi_sb, pl_13_33_2
    global string_number_pw_23_33, string_number_pw_13_33_away
    global string_number_save, start_away, string_number_headers
    global lpi_defense_2, string_number_pw_23
    global string_number_pw_away, pw_13_33_home_2
    global lpi_attack_tb_2, string_number_kp
    global string_number_pw_13_33, string_number_pw_13_away
    global lpi_attack_tb_2, string_number_gkto
    global pl_33_23_2, string_number_pw_13
...
Great! I hope %s has a good game!
    ...
    cross_range = range(0, 1000)
    cross_list = list(cross_range)

    cross_range_gd = range(0, 1000)
    cross_list_gd = list(cross_range_gd)

    cross_range_pd = range(0, 1000)
    cross_list_pd = list(cross_range_pd)
    ...
    shot_range_gd = range(0, 1000)
    shot_list_gd = list(shot_range_gd)

    shot_range_pd = range(0, 1000)
    shot_list_pd = list(shot_range_pd)

    shot_range_bs = range(0, 1000)
    shot_list_bs = list(shot_range_bs)
    ...
    header_range_gd = range(0, 1000)
    header_list_gd = list(header_range_gd)

    header_range_pd = range(0, 1000)
    header_list_pd = list(header_range_pd)
    ...
    save_range = range(0, 1000)
    save_list = list(save_range)
...
'''
    ...
    int_number_cross_gd = False
    int_number_cross_pd = False
    int_number_crosses = False

    int_number_shot_gd = False
    int_number_shot_pd = False
    int_number_shot_bs = False
    int_number_shots = False

    int_number_header_gd = False
    int_number_header_pd = False
    ...
    while True:
        ...
        if choice in pk_words:
            ...
            if good_bad_input_pk in goal_words:
                ...
                pk_miss_2 = str(number_pk_missed)
        ...
        # -----> * Free Kicks Function * <-----
            ...
            if good_bad_input_fk in fk_gd_words:
                ...
                fk_string_gd_2 = str(number_fk_gd)
                int_number_fk_gd = True
                fk_string_gd_1 = "Free Kick(s) with Good Delivery: "
                ...
                fk_string_pd_2 = str(number_fk_pd)
                int_number_fk_pd = True
                fk_string_pd_1 = "Free Kick(s) with Poor Delivery: "
        ...
        # -----> * Corner Kick Variables * <-----
            ...
            if good_bad_input_ck in ck_gd_words:
                ...
                ck_string_gd_2 = str(number_ck_gd)
                int_number_ck_gd = True
                ck_string_gd_1 = "Corner Kick(s) with Good Delivery: "
                ...
                ck_string_pd_2 = str(number_ck_pd)
                int_number_ck_pd = True
                ck_string_pd_1 = "Corner Kick(s) with Poor Delivery: "
        ...
        # -----> * Throw Ins Functions * <-----
            ...
            if good_bad_input_ti in ti_gd_words:
                ...
                ti_string_gd_2 = str(number_ti_gd)
                int_number_ti_gd = True
                ti_string_gd_1 = "Throw In(s) with Good Delivery: "
                ...
                ti_string_pd_2 = str(number_ti_pd)
                int_number_ti_pd = True
                ti_string_pd_1 = "Throw In(s) with Poor Delivery: "
                ti_string_pd_2 = ti_string_pd_2
        ...
        # -----> * Crosses Function * <-----
            ...
            if good_bad_input_crosses in cross_gd_words:
                ...
                first_number_cross_gd = cross_list_gd[0]
                cross_list_gd.remove(first_number_cross_gd)
                number_cross_gd = cross_list_gd[0]
                cross_string_gd_2 = str(number_cross_gd)
                int_number_cross_gd = True
                cross_string_gd_1 = "Cross(es) with Good Delivery: "
                cross_string_gd_2 = cross_string_gd_2
                ...
                first_number_cross_pd = cross_list_pd[0]
                cross_list_pd.remove(first_number_cross_pd)
                number_cross_pd = cross_list_pd[0]
                cross_string_pd_2 = str(number_cross_pd)
                int_number_cross_pd = True
                cross_string_pd_1 = "Cross(es) with Poor Delivery: "
                cross_string_pd_2 = cross_string_pd_2
                cross_print_string_pd = cross_string_pd_1 + cross_string_pd_2
                print(red % cross_print_string_pd)

            first_number_crosses = cross_list[0]
            cross_list.remove(first_number_crosses)
            number_crosses = cross_list[0]
        ...
        # -----> * 1 versus 1 Function * <-----
            ...
            int_number_v1 = True
            v1_print_string = "Total 1vs1: " + string_number_v1
        ...
        # -----> * Shots Function * <-----
            ...
            if good_bad_input_shots in shot_ont_words:
                ...
                first_number_shot_gd = shot_list_gd[0]
                shot_list_gd.remove(first_number_shot_gd)
                number_shot_gd = shot_list_gd[0]
                shot_string_ont_2 = str(number_shot_gd)
                int_number_shot_gd = True
                ...
                first_number_shot_pd = shot_list_pd[0]
                shot_list_pd.remove(first_number_shot_pd)
                number_shot_pd = shot_list_pd[0]
                shot_string_oft_2 = str(number_shot_pd)
                int_number_shot_pd = True
                ...
                first_number_shot_bs = shot_list_bs[0]
                shot_list_bs.remove(first_number_shot_bs)
                number_shot_bs = shot_list_bs[0]
                shot_string_bs_2 = str(number_shot_bs)
                int_number_shot_bs = True
                shot_string_bs_1 = "Blocked Shot(s): "
                shot_print_string_bs = shot_string_bs_1 + shot_string_bs_2
                print(red % shot_print_string_bs)

            first_number_shots = shot_list[0]
            shot_list.remove(first_number_shots)
            number_shots = shot_list[0]
        ...
        # -----> * Headers Function * <-----
            ...
            if good_bad_input_headers in header_ont_words:
                ...
                first_number_header_gd = header_list_gd[0]
                header_list_gd.remove(first_number_header_gd)
                number_header_gd = header_list_gd[0]
                header_ont_2 = str(number_header_gd)
                int_number_header_gd = True
                ...
                first_number_header_pd = header_list_pd[0]
                header_list_pd.remove(first_number_header_pd)
                number_header_pd = header_list_pd[0]
                header_oft_2 = str(number_header_pd)
                int_number_header_pd = True
                header_oft_1 = "Header(s) off target: "
                header_print_string_oft = header_oft_1 + header_oft_2
                print(red % header_print_string_oft)

            first_number_headers = header_list[0]
            header_list.remove(first_number_headers)
            number_headers = header_list[0]
            int_number_crosses = True
            header_1 = "Header(s): "
            header_2 = str(number_headers)
            header_print_string = header_1 + header_2
        ...
        # -----> * Saves * <-----
            ...
            first_number_save = save_list[0]
            save_list.remove(first_number_save)
            number_save = save_list[0]
            string_number_save = str(number_save)
            int_number_saves = True
            save_print_string = "Save(s): " + string_number_save
            print(white % save_print_string)
        ...
        # -----> * Possession Loss * <-----
            ...
            gkto_print_string = "Goalkeeper Turnover: " + string_number_gkto
            ...
            int_number_kp = True
            kp_print_string = "Key Pass(es): " + string_number_kp
