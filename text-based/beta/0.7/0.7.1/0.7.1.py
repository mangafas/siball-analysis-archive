...
'''
    ...
    global string_number_cross_gd, string_number_cross_pd
    global string_number_header_pd, string_number_header_gd
    ...
    while True:
        ...
        # -----> * Crosses Function * <-----
            ...
            if good_bad_input_crosses in cross_gd_words:
                ...
                string_number_cross_gd = str(number_cross_gd)
                int_number_cross_gd = True
                cross_string_gd_1 = "Cross(es) with a Good Delivery: "
                cross_string_gd_2 = string_number_cross_gd
                ...
                string_number_cross_pd = str(number_cross_pd)
                int_number_cross_pd = True
                cross_string_pd_1 = "Cross(es) with a Poor Delivery: "
                cross_string_pd_2 = string_number_cross_pd
        ...
        # -----> * Shots Function * <-----
            ...
            if good_bad_input_shots in shot_ont_words:
                ...
                string_number_shot_gd = str(number_shot_gd)
                int_number_shot_gd = True
                shot_string_ont_1 = "Shot(s) on target: "
                shot_string_ont_2 = string_number_shot_gd
                ...
                string_number_shot_pd = str(number_shot_pd)
                int_number_shot_pd = True
                shot_string_oft_1 = "Shot(s) off target: "
                shot_string_oft_2 = string_number_shot_pd
                ...
                string_number_shot_bs = str(number_shot_bs)
                int_number_shot_bs = True
                shot_string_bs_1 = "Blocked Shot(s): "
                shot_string_bs_2 = string_number_shot_bs
        ...
        # -----> * Headers Function * <-----
            ...
            if good_bad_input_headers in header_ont_words:
                ...
                string_number_header_gd = str(number_header_gd)
                int_number_header_gd = True
                header_ont_1 = "Header(s) on target: "
                header_ont_2 = string_number_header_gd
                ...
                string_number_header_pd = str(number_header_pd)
                int_number_header_pd = True
                header_oft_1 = "Header(s) off target: "
                header_oft_2 = string_number_header_pd
        ...
        # if the user wants to quit he types q to begin the process
            ...
            int_final_cross_gd = int(string_number_cross_gd)
            int_final_cross_pd = int(string_number_cross_pd)
            ...
            if int_number_cross_gd:
                ...
                print(end_cross_gd + string_number_cross_gd)
                safile.write("\nCross(es) with Good Delivery: ")
                safile.write(string_number_cross_gd)
            ...
            if int_number_cross_pd:
                ...
                print(end_cross_pd + string_number_cross_pd)
                safile.write("\nCross(es) with Poor Delivery: ")
                safile.write(string_number_cross_pd)
            ...
            int_final_shot_gd = int(string_number_shot_gd)
            int_final_shot_pd = int(string_number_shot_pd)
            int_final_shot_bs = int(string_number_shot_bs)
            ...
            if int_number_shot_gd:
                print("Shot(s) on Target: ", string_number_shot_gd)
                safile.write("\nShot(s) on Target: ")
                safile.write(string_number_shot_gd)
            elif not int_number_shot_gd:
                print("Shot(s) on Target: 0")
                safile.write("\nShot(s) on Target: 0")

            if int_number_shot_pd:
                print("Shot(s) off Target: ", string_number_shot_pd)
                safile.write("\nShot(s) off Target: ")
                safile.write(string_number_shot_pd)
            elif not int_number_shot_pd:
                print("Shot(s) off Target: 0")
                safile.write("\nShot(s) off Target: 0")

            if int_number_shot_bs:
                print("Blocked Shot(s): ", string_number_shot_bs)
                safile.write("\nBlocked Shot(s): ")
                safile.write(string_number_shot_bs)
            ...
            int_final_header_gd = int(string_number_header_gd)
            int_final_header_pd = int(string_number_header_pd)
            ...
            if int_number_header_gd:
                print("Header(s) on Target: ", string_number_header_gd)
                safile.write("\nHeader(s) on Target: ")
                safile.write(string_number_header_gd)
            elif not int_number_header_gd:
                print("Header(s) on Target: 0")
                safile.write("\nHeader(s) on Target: 0")

            if int_number_header_pd:
                print("Header(s) off Target: ", string_number_header_pd)
                safile.write("\nHeader(s) off Target: ")
                safile.write(string_number_header_pd)
