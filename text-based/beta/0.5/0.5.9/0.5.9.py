...
2/3
    ...
    transition_range_23 = range(0, 1000)
    transition_list_23 = list(transition_range_23)
    transition_range_23_33 = range(0, 1000)
    transition_list_23_33 = list(transition_range_23_33)
    transition_range_13 = range(0, 1000)
    transition_list_13 = list(transition_range_13)
    transition_range_13_33 = range(0, 1000)
    transition_list_13_33 = list(transition_range_13_33)
    transition_range_13_23 = range(0, 1000)
    transition_list_13_23 = list(transition_range_13_23)
    transition_input = '''2/3
1/3
'''
    defense_transition_print = '''3/3
2/3'''

    transition_words = ["transition", "Transition", "Transition ", "transition"]
    transition_midfield_words = ["midfield", "Midfield", "MIDFIELD", "midfield ", "Midfield ", "MIDFIELD ", "m", "23",
                                 "2/3", "23 ", "2/3 "]

    transition_defense_words = ["defense", "Defense", "DEFENSE", "defense ", "Defense ", "DEFENSE ", "d", "13", "1/3",
                                "13 ", "1/3", "113"]
    defense_attack_transition_words = ["attack", "Attack", "ATTACK", "attack ", "Attack ", "ATTACK ", "a", "33", "3/3",
                                       "33 ", "3/3 "]
    defense_midfield_transition_words = ["midfield", "Midfield", "MIDFIELD", "midfield ", "Midfield ", "MIDFIELD ", "m",
                                         "23", "2/3", "23 ", "2/3 "]
    ...
    global string_number_pl_33, string_number_pl_23_33, string_number_pl_33_13, string_number_pl, string_number_transition
    ...
    int_number_transition_13 = False
    int_number_transition_13_23 = False
    int_number_transition_13_33 = False
    int_number_transition_23 = False
    int_number_transition_23_33 = False
    ...
    while True:
        ...
        # -----> * Possession Loss * <-----
            ...
            good_bad_input_transition = input(transition_input)

            if good_bad_input_transition in transition_midfield_words:

                first_number_transition_23_33 = transition_list_23_33[0]
                transition_list_23_33.remove(first_number_transition_23_33)
                number_transition_23_33 = transition_list_23_33[0]
                string_number_transition_23_33 = str(number_transition_23_33)
                int_number_transition_23_33 = True
                transition_print_string_23_33 = "Possession lost on midfield that came from Defense: " + string_number_transition_23_33
                print(white % transition_print_string_23_33)

                first_number_transition_23 = transition_list_23[0]
                transition_list_23.remove(first_number_transition_23)
                number_transition_23 = transition_list_23[0]
                string_number_transition_23 = str(number_transition_23)
                int_number_transition_23 = True
                transition_print_string_23 = "Possession lost on midfield: " + string_number_transition_23
                print(white % transition_print_string_23)

            elif good_bad_input_transition in transition_defense_words:

                defense_input = input(defense_transition_print)

                if defense_input in defense_attack_transition_words:

                    first_number_transition_13_33 = transition_list_13_33[0]
                    transition_list_13_33.remove(first_number_transition_13_33)
                    number_transition_13_33 = transition_list_13_33[0]
                    string_number_transition_13_33 = str(number_transition_13_33)
                    int_number_transition_13_33 = True
                    transition_print_string_13_33 = "Transition started from defense and : " + string_number_transition_13_33
                    print(white % transition_print_string_13_33)

                elif defense_input in defense_midfield_transition_words:

                    first_number_transition_13_23 = transition_list_13_23[0]
                    transition_list_13_23.remove(first_number_transition_13_23)
                    number_transition_13_23 = transition_list_13_23[0]
                    string_number_transition_13_23 = str(number_transition_13_23)
                    int_number_transition_13_23 = True
                    transition_print_string_13_23 = "Possession lost on defense that came from midfield: " + string_number_transition_13_23
                    print(white % transition_print_string_13_23)

                first_number_transition_13 = transition_list_13[0]
                transition_list_13.remove(first_number_transition_13)
                number_transition_13 = transition_list_13[0]
                string_number_transition_13 = str(number_transition_13)
                int_number_transition_13 = True
                transition_print_string_13 = "Possession lost on defense: " + string_number_transition_13
                print(white % transition_print_string_13)
            ...
            transition_print_string = "Transitions:" + string_number_transition
        ...
        # if the user wants to quit he types q to begin the process
            ...
            print_home = home + "had" + string_home + "%"
            print_away = away + "had " + string_away + "%"
            ...
            if int_number_transition_23_33:
                print("Offensive transitions that came from midfield: ", string_number_transition_23_33)
                safile.write("\nOffensive transitions that came from midfield: ")
                safile.write(string_number_transition_23_33)
            elif not int_number_transition_23_33:
                print("Offensive transitions that came from midfield: 0")
                safile.write("\nOffensive transitions that came from midfield: 0")

            if int_number_transition_23:
                print("Transitions that came from midfield: ", string_number_transition_23)
                safile.write("\nTransitions that came from midfield: ")
                safile.write(string_number_transition_23)
            elif not int_number_transition_23:
                print("Transitions that came from midfield: 0")
                safile.write("\nTransitions that came from midfield: 0")

            if int_number_transition_13_33:
                print("Offensive transitions that came from defense: ", string_number_transition_13_33)
                safile.write("\nOffensive transitions that came from defense: ")
                safile.write(string_number_transition_13_33)
            elif not int_number_transition_13_33:
                print("Offensive transitions that came from defense: 0")
                safile.write("\nOffensive transitions that came from defense: 0")

            if int_number_transition_13_23:
                print("Midfield transitions that came from defense: ", string_number_transition_13_23)
                safile.write("\nMidfield transitions that came from defense: ")
                safile.write(string_number_transition_13_23)
            elif not int_number_transition_13_23:
                print("Midfield transitions that came from defense: 0")
                safile.write("\nMidfield transitions that came from defense: 0")

            if int_number_transition_13:
                print("Transitions that came from defense: ", string_number_transition_13)
                safile.write("\nTransitions that came from defense: ")
                safile.write(string_number_transition_13)
            elif not int_number_transition_13:
