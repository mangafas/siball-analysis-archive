...
def body():
    ...
    while True:
        ...
        # -----> * Possession Loss * <-----
            ...
            elif good_bad_input_pl == "2/3":

                midfield_input = input(midfield_print)

                if midfield_input == "3/3":
            ...
            elif good_bad_input_pl == "1/3":
                defense_input = input(defense_print)

                if defense_input == "3/3":
