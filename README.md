...
![alt tag](https://img.shields.io/badge/version-v0.5.9-blue.svg)
![alt tag](https://img.shields.io/badge/in progress-v0.6.1-0000fe.svg)
...
It's a work in progress having released three official alpha releases 0.3.1, 0.4.1, 0.4.5 and two beta releases 0.5.1 and 0.5.9. Official Releases will be on github on a every minor change and last patch (major.__minor__._patch_). Currently we are on 0.5.9. The next version will be 0.6.1. that is not yet developed. Designed and Engineered with **Python** with **subprocess** and **time** library
